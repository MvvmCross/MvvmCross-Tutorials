...
namespace FractalGen.Core.Services
{
    public class Mandelbrot : IMandelbrot
    {
        ...
        private readonly IWriteableBitmap _bitmap;
        public IWriteableBitmap Bitmap
        {
            get { return _bitmap; }
        }
        ...
        public Mandelbrot(Limits limits, List<MvxColor> colorArray, IWriteableBitmap bitmap)
        {
